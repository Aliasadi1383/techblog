...
Pages._();
 static  List<GetPage<dynamic>> pages= [
        ...
        GetPage(name:NamedRoute.singleManageArticle, page:()=> const SingleManageArticle(),binding: ArticleManagerBinding()),
        GetPage(name:NamedRoute.singlePodcast, page:()=>PodcastSingle()),
      ];
